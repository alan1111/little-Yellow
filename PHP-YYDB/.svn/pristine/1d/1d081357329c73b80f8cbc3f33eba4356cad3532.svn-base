...
class annoModule extends MainBaseModule
{
	...
	{		
		...
		$sql = "SELECT
                	id,name,progress AS progress,icon, lottery_sn, has_lottery, success_time,
		...
		$sql_unopen = "SELECT
                	DuobaoItem.id AS id, DuobaoItem.deal_id AS deal_id, DuobaoItem.duobao_id AS duobao_id, DuobaoItem.name AS duobaoitem_name,DuobaoItem.progress AS progress,
