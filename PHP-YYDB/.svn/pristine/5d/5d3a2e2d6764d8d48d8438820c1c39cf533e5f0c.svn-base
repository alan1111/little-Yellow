...
class SAASAPIServer
{
     ...
     *                1) domains     授权域名列表，json格式字符串，如：["u1.o2o.nthxmai.com","*.yydb.nthxmai.com"]
     *                2) license     授权文件内容
    ...
    /**
     * 从谷创商城系统间传递的安全地址中提取所传递的安全参数，并返回安全参数数组。如果参数已超时，那么返回false
     * @param $url 谷创商城系统间传递的安全地址（带有加密后的安全参数），也可直接为请求参数字符串
    ...
    /**
     * 解密谷创商城系统间传递的安全地址中的加密参数。如果参数已超时，那么返回false
