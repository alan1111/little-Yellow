    ...
    public function index(){
		...
		$root['cart_info']=duobao::getcart($GLOBALS['user_info']['id']);
    		...
    		$sql = "select di.*,sum(doi.number) as number from ".DB_PREFIX."deal_order_item as doi ".
    				" left join ".DB_PREFIX."duobao_item as di on doi.duobao_item_id = di.id where doi.user_id = ".$user_id." and doi.refund_status = 0 and doi.pay_status = 2 and di.is_effect = 1  and doi.type = 2 ";
