...
function my_no_all(id,user_id,order_item_id)
{
		...
		{
			 $.weeboxs.open(duobao_no_html['sn'+id], {title:'全部夺宝号码', contentType:'', width:600,showOk:false,showCancel:false});
		}
		else
		{
			$.ajax({
		        ...
		        dataType:"json",
		        success:function(obj){
	                $.weeboxs.open(obj.html, {title:'全部夺宝号码', contentType:'', width:600,showOk:false,showCancel:false});
