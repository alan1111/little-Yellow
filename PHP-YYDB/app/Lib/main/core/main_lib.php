...
function init_app_page()
{
	...
	if(MODULE_NAME=='cart' && ACTION_NAME=='check' ){
		//do nothing
	}else{
		
		$GLOBALS['db']->query("update ".DB_PREFIX."deal_cart set is_effect=1 where session_id = '" . es_session::id () . "' and user_id = " . $GLOBALS['user_info']['id'] );
