...
<div class="main-banner f_l">
		<div id="slideBox" class="slideBox">
			...
			<div class="bd">
				<div class="tempWrap">
					<ul class="tu">
						<?php echo show_adv("slide","<li>__ADV_CODE__</li>","350","0");  ?>
					</ul>
				</div>
			</div>
...
?>
				...
				<div class="hover_line">
					<?php if ($this->_var['hot_duobao']['min_buy'] == 10): ?>
...
?>" class="goods-title" title="<?php echo $this->_var['hot_duobao']['name']; ?>">
							<?php echo $this->_var['hot_duobao']['name']; ?>
						</a>
...
<div class="wrap_full_w">
	<?php if ($this->_var['cate_list_product']): ?>
		<?php $_from = $this->_var['cate_list_product']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cate_list_0_63736900_1504576803');if (count($_from)):
    foreach ($_from AS $this->_var['cate_list_0_63736900_1504576803']):
?>
		 <?php if ($this->_var['cate_list_0_63736900_1504576803']['duobao_list']): ?>
		<div class="index-goods-list" style="width: 1201px">
			<h1 class="main-title">
				<span><?php echo $this->_var['cate_list_0_63736900_1504576803']['name']; ?></span>
			<a href="<?php
...
?>" class="title-more">更多商品，点击查看>></a>
			...
			<li class="cate_list">
			<img src="<?php echo $this->_var['cate_list_0_63736900_1504576803']['image']; ?>" width="238" height="400"  >
			
			<!-- <?php echo show_adv("cate_banner","","238","400");  ?> -->
			</li>
			<?php $_from = $this->_var['cate_list_0_63736900_1504576803']['duobao_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'hot_duobao');if (count($_from)):
    foreach ($_from AS $this->_var['hot_duobao']):
?>
				<li class="goods ui-item">
				<div class="hover_line">
...
?>
				<li class="goods ui-item">
				<div class="hover_line">
				<?php if ($this->_var['newest_duobao']['min_buy'] == 10): ?>
					<div class="ico logo-box ten-logo-box"></div>
					<?php endif; ?>
...
?>" class="goods-title" title="<?php echo $this->_var['newest_duobao']['name']; ?>">
							<?php echo $this->_var['newest_duobao']['name']; ?>
						</a>
						<div class="p-price f_l">
