...
<div class="top_nav">
	<div class="wrap_full_w">
		<span class="f_l">欢迎来到谷创通宝夺宝</span>
		<span class="f_r">
			<ul class="head_tip">
	...
	<div class="f_l">
		<div class="logo">
			<a class="link" href="<?php echo $this->_var['APP_ROOT']; ?>/">
                 <img src="./app/Tpl/main/fanwe/images/default_logo.png" style="margin-top:10px;"/>
	         </a>
		</div>
		
	</div>
	
	<div class="f_l" style="margin-left:100px; margin-top:10px;">
		<div class="cart_tip_margin f_r" onclick="javascript:window.location ='./index.php?ctl=cart'">
			 ...
			 <div class="cart-count-wrap">
				...
				<b class="cart_count"><?php echo $this->_var['cart_info']['cart_item_num']; ?></b>
			</div>
		    </a>
	   </div>
...
<div style="position:fixed; right:0;top:30px;z-index: 999;">
		<img src="./app/Tpl/main/fanwe/images/lih.gif" width="80%" height="auto"/>
</div>
...
?>
		...
		<a href="javascript:window.location ='./index.php?ctl=cart'" class="cart_tip f_r">
			<i class="ico ico-mini-cart"></i>
			<span class="cart_title">清单</span>
			<div class="cart-count-wrap">
			<i class="ico ico-white-solid ico-white-solid-l"></i>
